...
@section('content')
    ...
    <form method="post" action="{{ route('login') }}">
        ...
        <fieldset class="fieldset w-sm bg-base-200 border border-base-300 p-4 rounded-box">
                ...
                <input type="email" name="email" class="input rounded-full w-full" placeholder="Email" />
                
                <label class="fieldset-label">Password</label>
                <input type="password" name="password" class="input rounded-full w-full" placeholder="Password" />
